# computer-science-ja (独学 コンピュータサイエンス)

Based on [bakatsuyuki/TeachYourselfCS-JP](https://github.com/bakatsuyuki/TeachYourselfCS-JP/)
...
オペレーティングシステム：Three Easy Piecesは、[オンライン](http://github.com/syarochan/Operating-Systems-Three-Easy-Pieces-in-japanese)で無料で入手できる優れた代替手段です。 私たちは特に本の構造と読みやすさが好きで、演習は価値があると感じています。
